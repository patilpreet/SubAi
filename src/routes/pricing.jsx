    ...
    <Layout>
      <section className="pt-36 pb-16 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[var(--text-secondary)] max-w-2xl mx-auto text-[16px] leading-relaxed">
      ...
      <section className="px-6 pb-28">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-center gap-4 mb-10">
            ...
            >
              <span
                className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white transition-transform duration-150 ${yearly ? "translate-x-6" : "translate-x-0"
                  }`}
              />
            </button>
            <div className="flex items-center gap-2">
              ...
              {yearly && <span className="text-[10px] text-[var(--primary)] font-bold">12% off</span>}
            </div>
          </div>
      ...
      <section className="px-6 pb-28 border-t border-[var(--border-base)] pt-20">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[var(--border-base)]">
                  <th className="text-left py-3 pr-4 text-[var(--text-secondary)] font-medium" />
                  <th className="text-center py-3 px-4 text-[var(--text-secondary)] font-medium">Free</th>
                  <th className="text-center py-3 px-4 text-[var(--text-secondary)] font-medium">Starter</th>
                  <th className="text-center py-3 px-4 text-[var(--primary)] font-medium">Editor</th>
                  <th className="text-center py-3 px-4 text-[var(--text-secondary)] font-medium">Pro</th>
                </tr>
              </thead>
              <tbody>
                {[
